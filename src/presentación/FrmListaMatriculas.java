...
public class FrmListaMatriculas extends javax.swing.JFrame {

    DefaultTableModel dtmEstudiantes = new DefaultTableModel();
    
    public FrmListaMatriculas(javax.swing.JFrame parent) {
        initComponents();
    ...
    private void initComponents() {
        ...
        title.setText("LISTA DE MATRICULAS");
        ...
        jLabel2.setText("¡Hacer clic en la lista y escribir el código para una búsqueda más rápida!");
        jLabel2.setPreferredSize(new java.awt.Dimension(505, 30));
        jPanel1.add(jLabel2);
